...
class ValidatesDate
  ...
  attr_reader :date_of_birth, :date_of_start, :date_of_finish, :date_of_expiry, :date_of_arrival
  ...
  validates_date :date_of_arrival, on_or_after: :today
end
...
describe ValidatesDate do
  ...
  it { is_expected.to validates_date(:date_of_arrival).on_or_after(:today) }
end
