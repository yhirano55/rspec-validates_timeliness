...
class ValidatesDatetime
  ...
  attr_reader :started_at, :finished_at, :created_at, :updated_at, :checked_at
  ...
  validates_datetime :checked_at, on_or_after: :now
end
...
describe ValidatesDatetime do
  ...
  it { is_expected.to validates_datetime(:checked_at).on_or_after(:now) }
end
